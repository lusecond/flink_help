...
//        super(new KeyedSerializationSchemaWrapper<List<Row>>());
...
//        System.out.println("执行addBatch后的数据条数是：" + data.size());
    ...
    void flush() {
        ...
        try {
            log.info("start executeBatch...");
//            System.err.println("start executeBatch.......");
    ...
    public void snapshotState(FunctionSnapshotContext context) throws Exception {
        log.info("start snapshotState...");
//        System.err.println("start snapshotState.......");
...
//    public final void  notifyCheckpointComplete() {
...
//        System.err.println("start recoverAndCommit.......");
...
//        System.err.println("start recoverAndAbort.......");
    }
...
//        System.err.println("start abort rollback.......");
        if (connection != null) {
            try {
                log.error("执行事务回滚,Connection:" + connection);
                connection.rollback();
            } catch (SQLException e) {
...
//            this.flush();
            ...
            try {
                log.info("准备关闭ps:{} ...",this.prepareStatement);
