...
public class SinkToMySQLMsg extends RichSinkFunction<List<Msg>> {
     ...
     */
    @Override
    public void invoke(List<Msg> msg, Context context) throws Exception {
        //遍历数据集合
        for (Msg msg2 : msg) {
            Employee2 model2 = gson.fromJson(msg2.msg(), Employee2.class);
