...
import com.feiyu.gflow.streaming.LogParser;
...
public class SinkToMySQLString extends RichSinkFunction<List<String>> implements Serializable {
     ...
     */
    @Override
    public void invoke(List<String> strings, Context context) throws Exception {
        //遍历数据集合
        for (String string : strings) {

//            Employee2 model2 = g.fromJson(string, Employee2.class);
